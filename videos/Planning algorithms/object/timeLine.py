...
class Timeline(VGroup):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dot = Dot(
            self.year_to_position(self.initial_year), radius=0.1, color=BLUE
        ).set_glow_factor(1.5)
        self.marker = Line(
    ...
    def _build_main_line_and_extensions(self):
        ...
        self.left_extension = Line(
            LEFT * (l + 1), LEFT * l, stroke_color=[WHITE, GRAY_E]
        ).set_z_index(10)
        self.right_extension = Line(
            RIGHT * l, RIGHT * (l + 1), stroke_color=[GRAY_E, WHITE]
        ).set_z_index(10)
        ...
        self.left_rectangle.move_to(
            [
                self.left_extension.get_right()[0] - self.left_extension.width * 0.75,
        ...
        self.right_rectangle.move_to(
            [
                self.right_extension.get_left()[0] + self.right_extension.width * 0.75,
        ...
        self.main_line = Line(LEFT * l * 20, RIGHT * l * 20, color=WHITE)
    ...
    def _build_ticks(self):
        ...
        for year in years:
            ...
            tick = Line([x, -0.15, 0], [x, 0.15, 0], color=WHITE)
            label = Text(str(year), font_size=20).move_to([x, -0.5, 0])
        ...
        self.updater_show_stick(self.labels)
    ...
    def animate_select_year(self, year, label_text=None):
        animation = []
        ...
        animation.append(self.timeLine.animate.shift(RIGHT * shift_x))
        ...
        label = Text(
            label_text or f"{year} MILLION YEARS AGO",
            font_size=36,
            font="JetBrains Mono",
        ...
        # else:
        #     target_pos = self.year_to_position(year)
        #     label = Text(
        #         label_text or f"{year} MILLION YEARS AGO",
        #         font_size=36,
        #         font="JetBrains Mono",
        ...
        #     animation.append(
        #         AnimationGroup(
        #             self.dot.animate.move_to(target_pos),
        #             self.marker.animate.move_to(target_pos),
        #             rate_func=rate_functions.rush_from,
        #             run_time=2,
        #         )
        #     )
